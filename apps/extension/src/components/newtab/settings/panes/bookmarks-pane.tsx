	...
	return (
		<div className="space-y-3">
			...
			<SectionCard
				...
				description="Browse, organize, and manage bookmarks by folder"
				action={
					<Button
						type="button"
						size="sm"
			...
			{isAddingLink && (
				<SectionCard
					...
					description="Enter website URL and metadata"
				>
			...
			<SectionCard title="Thumbnail Capture">
				<SettingRow
					label="Automatic thumbnail capture"
					description="Silently captures website preview screenshots in the background"
				>
					<Switch
