...
function BubbleContent({
	...
	return useRender({
		...
		props: mergeProps<"div">(
			{
				className: cn(
					"wrap-break-word w-fit min-w-0 max-w-full overflow-hidden rounded-3xl border border-transparent px-3.5 py-2.5 text-sm leading-relaxed group-data-[align=end]/bubble:self-end [button,a]:outline-none [button,a]:transition-all [button,a]:duration-200 [button,a]:ease-in-out [button,a]:focus-visible:border-ring [button,a]:focus-visible:ring-1 [button,a]:focus-visible:ring-ring/20 [button]:text-left",
					className,
				),
			},
			props,
