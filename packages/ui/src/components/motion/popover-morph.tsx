...
import { usePopoverPortalPosition } from "@klice-start/ui/components/motion/popover-position";
import { EASE_OUT, SPRING_PANEL } from "@klice-start/ui/lib/ease";
		...
		<AnimatePresence>
			{ctx.open ? (
				<motion.div
					...
					className="fixed z-[var(--speed-dial-layer-popover,70)]"
				>
					<motion.div
						ref={ctx.contentRef}
						id={ctx.contentId}
