...
function FileUploadRow({
	...
	return (
		<motion.li
			...
			className={cn(
				"squircle relative overflow-hidden rounded-xl border border-border bg-background p-3 [--squircle-r:8px]",
				classNames?.item,
			)}
		>
			<div className="flex items-center gap-3">
				<div
					className={cn(
						"squircle grid h-11 w-11 shrink-0 place-items-center rounded-lg bg-muted text-muted-foreground [--squircle-r:7px]",
						classNames?.leading,
					)}
				>
