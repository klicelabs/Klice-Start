		...
		<SelectPrimitive.Portal>
			...
			>
				<SelectPrimitive.Popup
					...
					className={cn(
						"data-open:fade-in-0 data-open:zoom-in-95 data-closed:fade-out-0 data-closed:zoom-out-95 relative isolate z-50 max-h-(--available-height) w-(--anchor-width) min-w-36 overflow-y-auto overflow-x-hidden rounded-xl border border-border/60 bg-popover/95 p-1 text-popover-foreground text-xs shadow-xl ring-1 ring-foreground/5 backdrop-blur-xl duration-100 data-closed:animate-out data-open:animate-in",
						className,
					)}
					{...props}
				>
