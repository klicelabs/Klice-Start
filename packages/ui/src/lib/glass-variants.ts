...
export const settingsSidebarStyles = [
	"backdrop-blur-[12px] backdrop-saturate-[1.25]",
	"bg-white/[0.16] dark:bg-white/[0.08]",
	"border border-white/[0.28] dark:border-white/[0.1]",
	"shadow-[0_8px_24px_rgba(15,23,42,0.1)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.24)]",
].join(" ");
export const settingsSidebarIconStyles = [
	"flex size-[26px] shrink-0 items-center justify-center rounded-[7px]",
	"text-white",
	"shadow-[inset_0_1px_0_rgba(255,255,255,0.30),0_1px_2px_rgba(0,0,0,0.15)]",
].join(" ");
...
export const glassVariantStyles: Record<FrostGlassVariant, string> = {
	...
	liquid: [
		...
		"shadow-[inset_0_1px_0_0_rgba(255,255,255,0.65),inset_0_-12px_24px_-10px_rgba(255,255,255,0.45),inset_0.5px_0_0_0_rgba(255,255,255,0.22),inset_-0.5px_0_0_0_rgba(255,255,255,0.18),0_24px_60px_-18px_rgba(15,23,42,0.30),0_8px_24px_-8px_rgba(15,23,42,0.18)]",
		"dark:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.30),inset_0_-14px_28px_-10px_rgba(180,210,255,0.18),inset_0.5px_0_0_0_rgba(255,255,255,0.10),inset_-0.5px_0_0_0_rgba(255,255,255,0.08),0_28px_70px_-18px_rgba(0,0,0,0.55),0_10px_28px_-10px_rgba(0,0,0,0.40)]",

		// 5) Hairline border for the chamfer's outer edge. Sub-pixel so it reads
		//    as a crisp edge, not a thick rim, on small controls.
		"border-[0.5px] border-white/[0.40] dark:border-white/[0.08]",
	].join(" "),
	"liquid-refract": "",
};
