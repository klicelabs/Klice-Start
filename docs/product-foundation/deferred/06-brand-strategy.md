...
## Out of Scope
Logo files, color tokens, campaign execution, pricing pages, ad copy, and design system components. Those belong to brand assets and design system documentation.

## Owners
Founders, Brand Lead, Head of Product, Head of Design.

## Dependencies
[Company Vision](../01-company-vision.md), [Design Manifesto](../05-design-manifesto.md), [Product Strategy](../02-product-strategy.md).

## Cross-References
Use this document for landing pages, store listings, changelogs, social posts, support replies, and community tone. Voice and tone decisions here must remain consistent with [Experience Principles](../04-experience-principles.md) — the brand is how the product speaks; the experience is how it behaves.
...
| Confidence | Confident without exaggeration. | Superlatives the product has not earned. |
| Warmth | Warm without being cute. | Infantilizing the user. |
| Premium register | Premium without sounding elitist. | Excluding language or superiority. |
| Honesty | Honest about limitations. | Overpromising future capabilities. |
...
- Prefer "your browser home" over vague dashboard language when explaining the product.
- Explain privacy and AI in concrete terms — what is used, where it goes, what the user controls.
- Write for the user reading it once, not for the team reviewing it for approval.

**Do:** "Your saved sites, organized the way you arranged them — on every device."
**Don't:** "Cloud-powered productivity engineered for the modern workflow."

## Communication Principles
- Show the product whenever possible. The product's appearance is its strongest argument.
- Communicate through quality, not claims. A polished changelog is worth more than an ad.
- Do not overpromise future capabilities. The roadmap is not a marketing asset.
- Treat support interactions as brand moments — tone in a bug reply is brand equity.
- Make trade-offs visible when they build trust. Saying what we chose not to do is credible.

## Marketing Principles
- Screenshots and motion should carry the message. If the product needs copy to explain why it is good, the product is not yet good enough.
- Growth comes from pride of ownership and sharing, not from paid interruption.
- Comparisons clarify category, never attack competitors. Critique the pattern, not the company.
- Never use fear, shame, or artificial scarcity as the core conversion mechanism.
- Marketing is permitted only to show what the product already is, not to imply what it will become.

## Community Principles
- Celebrate user setups. The user's screen is the best marketing asset we do not own.
- Reward taste and helpfulness over volume and noise.
- Keep community spaces calm and high-signal. A noisy community contradicts the product's promise.
- Invite feedback without letting the roadmap become a vote. Feedback is evidence, not instruction (see [Product Culture](./07-product-culture.md)).
